...
function fuzzycp($n1, $n2, $n3, $n4, $n5, $n6, $n7, $n8, $n9)
{
    // Data Inputan
    ...
    //Fuzzifikasi
        ...
        // Fuzzifikasi Visual
            ...
            if (($inputNilai[0] <= 2) || ($inputNilai[0] >= 7)) {
                $visualcukup = 0;
            } else if ($inputNilai[0] > 2 && $inputNilai[0] < 3) {
                $visualcukup = (($inputNilai[0] - 2) / 1);
            } else if ($inputNilai[0] > 5 && $inputNilai[0] < 7) {
                $visualcukup = ((-$inputNilai[0] + 7) / 2);
            } else if ($inputNilai[0] >= 3 && $inputNilai[0] <= 5) {
                $visualcukup = 1;
            };
        ...
        // Fuzzifikasi Sequences
            ...
            if (($inputNilai[3] <= 2) || ($inputNilai[3] >= 8)) {
                ...
                $sequenceburuk = ((-$inputNilai[3] + 8) / 2);
        ...
        // Fuzzifikasi System
            ...
            if (($inputNilai[6] <= 2) || ($inputNilai[6] >= 7)) {
                $systemcukup = 0;
            } else if ($inputNilai[6] > 2 && $inputNilai[6] < 3) {
                $systemcukup = (($inputNilai[6] - 2) / 1);
            } else if ($inputNilai[6] > 5 && $inputNilai[6] < 7) {
                $systemcukup = ((-$inputNilai[6] + 7) / 2);
            } else if ($inputNilai[6] >= 3 && $inputNilai[6] <= 5) {
                $systemcukup = 1;
            };
                                        ...
                                        for ($q = 0; $q < 3; $q++) {
                                            for ($r = 0; $r < 3; $r++) {
                                                if (($nilaivisual[$i] > 0) && ($nilainumerical[$j] > 0) && ($nilaiverbal[$l] > 0) && ($nilaisequence[$m] > 0) && ($nilaispatial[$n] > 0) && ($nilaitd[$o] > 0) && ($nilaisystem[$p] > 0) && ($nilaivocab[$q] > 0) && ($nilaifig[$r] > 0)) {
                                                    ...
                                                    if (($j == 2) && ($m == 2) && ($n == 2)) {
                                                        $kondisi[$k] = "TINGGI";
                                                    } else if ((($j >= 1) && ($m == 2) && ($n == 2)) || (($j == 2) && ($m >= 1) && ($n == 2)) || (($j == 2) && ($m == 2) && ($n >= 1))) {
                                                        $kondisi[$k] = "TINGGI";
                                                    } else if (($i == 2) && ($j >= 1) && ($l == 2) && ($m >= 1) && ($n >= 1) && ($o == 2) && ($p == 2) && ($q == 2) && ($r == 2)) {
                                                        $kondisi[$k] = "TINGGI";
                                                    } else {
                                                        $kondisi[$k] = "RENDAH";
                                                    }
    ...
    // Defuzzifikasi
        ...
        //return $infodef = "Kamu cocok menjadi 'Computer Programmer' Kamu memiliki nilai kecocokan sebesar : " . $hasildeffuzzifikasi;
