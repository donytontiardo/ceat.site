...
function fuzzycns($n1, $n2, $n3, $n4, $n5, $n6, $n7, $n8, $n9)
{
    // Data Inputan
    ...
    //Fuzzifikasi
        ...
        // Fuzzifikasi Numerical
            ...
            if ($inputNilai[1] <= 4) {
                ...
                $numericalbagus = (($inputNilai[1] - 4) / 2);
        ...
        // Fuzzifikasi 3D
            if (($inputNilai[5] <= 1) && ($inputNilai[5] >= 0)) {
                $tdburuk = 1;
            } else if ($inputNilai[5] < 3) {
                $tdburuk = ((-$inputNilai[5] + 3) / 2);
            } else $tdburuk = 0;
            
            if (($inputNilai[5] <= 1) || ($inputNilai[5] >= 5)) {
                $tdcukup = 0;
            } else if ($inputNilai[5] > 1 && $inputNilai[5] < 3) {
                $tdcukup = (($inputNilai[5] - 1) / 2);
            } else if ($inputNilai[5] > 3 && $inputNilai[5] < 5) {
                $tdcukup = ((-$inputNilai[5] + 5) / 2);
            } else if ($inputNilai[5] = 3) {
                $tdcukup = 1;
            };
        ...
        // Fuzzifikasi Vocabulary
            ...
            if (($inputNilai[7] <= 2) || ($inputNilai[7] >= 7)) {
                $vocabcukup = 0;
            } else if ($inputNilai[7] > 2 && $inputNilai[7] < 3) {
                $vocabcukup = (($inputNilai[7] - 2) / 1);
            } else if ($inputNilai[7] > 5 && $inputNilai[7] < 7) {
                $vocabcukup = ((-$inputNilai[7] + 7) / 2);
            } else if ($inputNilai[7] >= 3 && $inputNilai[7] <= 5) {
                $vocabcukup = 1;
            };
                                        ...
                                        for ($q = 0; $q < 3; $q++) {
                                            for ($r = 0; $r < 3; $r++) {
                                                if (($nilaivisual[$i] > 0) && ($nilainumerical[$j] > 0) && ($nilaiverbal[$l] > 0) && ($nilaisequence[$m] > 0) && ($nilaispatial[$n] > 0) && ($nilaitd[$o] > 0) && ($nilaisystem[$p] > 0) && ($nilaivocab[$q] > 0) && ($nilaifig[$r] > 0)) {
                                                    ...
                                                    if (($i == 2) && ($l == 2) && ($n == 2)) {
                                                        $kondisi[$k] = "TINGGI";
                                                    } else if ((($i >= 1) && ($l == 2) && ($n == 2)) || (($i == 2) && ($l >= 1) && ($n == 2)) || (($i == 2) && ($l == 2) && ($n >= 1))) {
                                                        $kondisi[$k] = "TINGGI";
                                                    } else if (($i >= 1) && ($j == 2) && ($l >= 1) && ($m == 2) && ($n >= 1) && ($o == 2) && ($p == 2) && ($q == 2) && ($r == 2)) {
                                                        $kondisi[$k] = "TINGGI";
                                                    } else {
                                                        $kondisi[$k] = "RENDAH";
                                                    }
    ...
    // Defuzzifikasi
        ...
        //return $infodef = "Kamu cocok menjadi 'Computer Network Specialist' Kamu memiliki nilai kecocokan sebesar : " . $hasildeffuzzifikasi;
