...
function fuzzyda($n1, $n2, $n3, $n4, $n5, $n6, $n7, $n8, $n9)
{
    // Data Inputan
    ...
    if (($inputNilai[0] <= 2) && ($inputNilai[0] >= 0)) {
        $visualburuk = 1;
    } else if ($inputNilai[0] < 3) {
        $visualburuk = ((-$inputNilai[0] + 3) / 1);
    } else $visualburuk = 0;

    if (($inputNilai[0] <= 2) || ($inputNilai[0] >= 6)) {
        $visualcukup = 0;
    } else if ($inputNilai[0] > 2 && $inputNilai[0] < 3) {
        $visualcukup = (($inputNilai[0] - 2) / 1);
    } else if ($inputNilai[0] > 4 && $inputNilai[0] < 6) {
        $visualcukup = ((-$inputNilai[0] + 6) / 2);
    } else if ($inputNilai[0] >= 3 && $inputNilai[0] <= 4) {
        $visualcukup = 1;
    };
    ...
    if ($inputNilai[0] <= 4) {
        ...
        $visualbagus = (($inputNilai[0] - 4) / 2);
    } else $visualbagus = 1;

    // Fuzzifikasi Numerical
    if (($inputNilai[1] <= 1) && ($inputNilai[1] >= 0)) {
        $numericalburuk = 1;
    } else if ($inputNilai[1] < 2) {
        $numericalburuk = ((-$inputNilai[1] + 2) / 1);
    } else $numericalburuk = 0;

    if (($inputNilai[1] <= 1) || ($inputNilai[1] >= 4)) {
        $numericalcukup = 0;
    } else if ($inputNilai[1] > 1 && $inputNilai[1] < 2) {
        $numericalcukup = (($inputNilai[1] - 1) / 1);
    } else if ($inputNilai[1] > 2 && $inputNilai[1] < 3) {
        $numericalcukup = ((-$inputNilai[1] + 3) / 1);
    } else if ($inputNilai[1] = 2) {
        $numericalcukup = 1;
    };
    ...
    if ($inputNilai[1] <= 2) {
        ...
        $numericalbagus = (($inputNilai[1] - 2) / 2);
    ...
    if (($inputNilai[3] <= 2) && ($inputNilai[3] >= 0)) {
        $sequenceburuk = 1;
    } else if ($inputNilai[3] < 4) {
        $sequenceburuk = ((-$inputNilai[3] + 4) / 2);
    } else $sequenceburuk = 0;

    if (($inputNilai[3] <= 2) || ($inputNilai[3] >= 8)) {
        $sequencecukup = 0;
    } else if ($inputNilai[3] > 2 && $inputNilai[3] < 4) {
        $sequencecukup = (($inputNilai[3] - 2) / 2);
    } else if ($inputNilai[3] > 6 && $inputNilai[3] < 8) {
        $sequencecukup = ((-$inputNilai[3] + 8) / 2);
    ...
    if ($inputNilai[3] <= 6) {
        ...
        $sequencebagus = (($inputNilai[3] - 6) / 2);
    ...
    if (($inputNilai[8] <= 1) && ($inputNilai[8] >= 0)) {
        $figburuk = 1;
    } else if ($inputNilai[8] < 2) {
        $figburuk = ((-$inputNilai[8] + 2) / 1);
    } else $figburuk = 0;

    if (($inputNilai[8] <= 1) || ($inputNilai[8] >= 4)) {
        $figcukup = 0;
    } else if ($inputNilai[8] > 1 && $inputNilai[8] < 2) {
        $figcukup = (($inputNilai[8] - 1) / 1);
    } else if ($inputNilai[8] > 2 && $inputNilai[8] < 3) {
        $figcukup = ((-$inputNilai[8] + 3) / 1);
    } else if ($inputNilai[8] = 2) {
        $figcukup = 1;
    };
    ...
    if ($inputNilai[8] <= 2) {
        $figbagus = 0;
    } else if ($inputNilai[8] > 2 && $inputNilai[8] < 4) {
        $figbagus = (($inputNilai[8] - 2) / 2);
    } else $figbagus = 1;
                                ...
                                for ($q = 0; $q < 3; $q++) {
                                    for ($r = 0; $r < 3; $r++) {
                                        if (($nilaivisual[$i] > 0) && ($nilainumerical[$j] > 0) && ($nilaiverbal[$l] > 0) && ($nilaisequence[$m] > 0) && ($nilaispatial[$n] > 0) && ($nilaitd[$o] > 0) && ($nilaisystem[$p] > 0) && ($nilaivocab[$q] > 0) && ($nilaifig[$r] > 0)) {
                                            ...
                                            if (($l == 2) && ($m == 2) && ($n == 2) && ($q == 2)) {
                                                $kondisi[$k] = "TINGGI";
                                            } else if ((($l >= 1) && ($m == 2) && ($n == 2)  && ($q == 2)) || (($l == 2) && ($m >= 1) && ($n == 2) && ($q == 2)) || (($l == 2) && ($m == 2) && ($n >= 1) && ($q == 2) || (($l == 2) && ($m == 2) && ($n == 2) && ($q >= 1)))) {
                                                $kondisi[$k] = "TINGGI";
                                            } else if (($i == 2) && ($j == 2) && ($l >= 1) && ($m >= 1) && ($n >= 1) && ($o == 2) && ($p == 2) && ($q >= 1) && ($r == 2)) {
                                                $kondisi[$k] = "TINGGI";
                                            } else {
                                                $kondisi[$k] = "RENDAH";
                                            }
    ...
    //return $infodef = "Kamu cocok menjadi 'Database Administrator' Kamu memiliki nilai kecocokan sebesar : " . $hasildeffuzzifikasi;
