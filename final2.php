...
<body>
	<main>
		...
		<div class="container">
			<table style="width:100%;margin-top:5%;margin-left:auto;margin-right:auto">
				<tr>
					<th>Hasil Akhir CNS</th>
				</tr>
				<tr>
					<td style="text-align: center;" id="hasil2">
		...
		<div class="container">
			<table style="width:100%;margin-top:5%;margin-left:auto;margin-right:auto">
				<tr>
					<th>Hasil Akhir CP</th>
				</tr>
				<tr>
					<td style="text-align: center;" id="hasil3">
		...
		<div class="container">
			<table style="width:100%;margin-top:5%;margin-left:auto;margin-right:auto">
				<tr>
					<th>Hasil Akhir CSA</th>
				</tr>
				<tr>
					<td style="text-align: center;" id="hasil4">
		...
		<div class="container">
			<table style="width:100%;margin-top:5%;margin-left:auto;margin-right:auto">
				<tr>
					<th>Hasil Akhir DA</th>
				</tr>
				<tr>
					<td style="text-align: center;" id="hasil5">
...
//$resultFuzzyche = fuzzyche(8, 8, 8, 8, 8, 8, 8, 8, 8);
...
//$resultFuzzycda = fuzzyda(0, 0, 0, 0, 0, 0, 0, 0, 0);
echo '<br>'.$resultFuzzyche.'<br>';
echo $resultFuzzycns.'<br>';
echo $resultFuzzycp.'<br>';
echo $resultFuzzycsa.'<br>';
echo $resultFuzzycda.'<br>';
echo '<br><br>';
?>
<script>
	var hasil1 = "<?php echo $resultFuzzyche; ?>";
	var hasil2 = "<?php echo $resultFuzzycns; ?>";
	var hasil3 = "<?php echo $resultFuzzycp; ?>";
	var hasil4 = "<?php echo $resultFuzzycsa; ?>";
	var hasil5 = "<?php echo $resultFuzzycda; ?>";

	var hasilDiv1 = document.getElementById("hasil1");
	hasilDiv1.innerHTML = hasil1;
	var hasilDiv2 = document.getElementById("hasil2");
	hasilDiv2.innerHTML = hasil2;
	var hasilDiv3 = document.getElementById("hasil3");
	hasilDiv3.innerHTML = hasil3;
	var hasilDiv4 = document.getElementById("hasil4");
	hasilDiv4.innerHTML = hasil4;
	var hasilDiv5 = document.getElementById("hasil5");
	hasilDiv5.innerHTML = hasil5;
</script>
<?
?>